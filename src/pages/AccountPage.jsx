      ...
      <section className="space-y-6">
        <div className={`glass-panel ${compact ? 'p-5' : 'p-6 sm:p-8'}`}>
          ...
          <form onSubmit={handleProfileSave} className="mt-8 grid gap-4 md:grid-cols-2">
            ...
            <label className="space-y-2 md:col-span-1">
              <span className="text-sm text-slate-300">Hudud</span>
              <input
                className="input-field"
            ...
            <label className="space-y-2 md:col-span-2">
              <span className="text-sm text-slate-300">Xo'jalik nomi</span>
              <input
                className="input-field"
        ...
        <div className={`glass-panel ${compact ? 'p-5' : 'p-6 sm:p-8'}`}>
          ...
          <form onSubmit={handlePasswordSave} className="mt-8 grid gap-4 md:grid-cols-2">
            <label className="space-y-2">
              <span className="text-sm text-slate-300">Joriy parol</span>
              <input
                className="input-field"
                type="password"
            ...
            <label className="space-y-2">
              <span className="text-sm text-slate-300">Yangi parol</span>
              <input
                className="input-field"
                type="password"
