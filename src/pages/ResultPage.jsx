      ...
      >
        ...
        <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
          ...
          <div className="rounded-[1.75rem] border border-emerald-300/20 bg-emerald-300/10 px-5 py-4 text-center">
            <p className="text-xs uppercase tracking-[0.22em] text-emerald-100">Ishonch</p>
            <p className="mt-2 font-display text-4xl text-white">{scan.confidence}%</p>
          </div>
        </div>
        ...
        <p className="mt-6 text-sm leading-7 text-slate-300">{scan.summary}</p>
      ...
      <div className="space-y-6">
        <section className="glass-panel p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="font-display text-2xl text-white">Sabab va tavsif</h2>
              <p className="mt-3 text-sm leading-7 text-slate-300">{disease.description}</p>
              <p className="mt-3 text-sm leading-7 text-slate-300">{disease.causes}</p>
            </div>
          </div>
        </section>
        ...
        <section className="glass-panel p-6">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 className="font-display text-2xl text-white">Sug'orish va profilaktika</h2>
              <p className="mt-3 text-sm leading-7 text-slate-300">{disease.irrigation}</p>
              <p className="mt-3 text-sm leading-7 text-slate-300">{disease.prevention}</p>
            </div>
          </div>
        </section>
      </div>
