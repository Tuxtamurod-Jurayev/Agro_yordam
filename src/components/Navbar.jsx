import { Leaf, LogOut, Menu, ScanLine, Settings2, ShieldCheck, Users, X } from 'lucide-react'
              ...
              {user?.role === 'admin' ? (
                <>
                  <NavLink
                    to="/dashboard"
                    onClick={() => setOpen(false)}
                    className="rounded-2xl px-4 py-3 text-sm text-emerald-200 transition hover:bg-emerald-300/10"
                  >
                    Dashboard
                  </NavLink>
                  <NavLink
                    to="/admin/users"
                    onClick={() => setOpen(false)}
                    className="rounded-2xl px-4 py-3 text-sm text-cyan-200 transition hover:bg-cyan-300/10"
                  >
                    Userlar CRUD
                  </NavLink>
                </>
